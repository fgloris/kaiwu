...
class Algorithm:
    ...
    def learn(self, list_sample_data):
        ...
        policy_mode = torch.stack([f.policy_mode for f in list_sample_data]).to(self.device).view(-1)
        ...
        logits, value_pred = self.model(vector_obs, map_obs, policy_mode=policy_mode)
