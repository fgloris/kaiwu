...
SampleData = create_cls(
    ...
    map_obs=Config.MAP_CHANNEL * Config.MAP_SIZE * Config.MAP_SIZE, # map_obs 先按 flatten 长度存，进模型前再 reshape 成 [B,Config.MAP_CHANNEL,Config.MAP_SIZE,Config.MAP_SIZE]
